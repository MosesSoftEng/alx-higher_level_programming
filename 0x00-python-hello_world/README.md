...
> pycodestyle 9-easter_egg.py; wc -m 9-easter_egg.py; chmod +x 9-easter_egg.py; ./9-easter_egg.py
...
> pycodestyle 100-write.py; wc -m 100-write.py; chmod +x 100-write.py; ./100-write.py
