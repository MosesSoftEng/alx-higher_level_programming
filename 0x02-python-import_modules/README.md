# :book: 0x02. Python - import & modules
...
> pycodestyle 3-infinite_add.py; chmod +x 3-infinite_add.py; ./3-infinite_add.py
> pycodestyle 3-infinite_add.py; chmod +x 3-infinite_add.py; ./3-infinite_add.py 79 10 -40 -300 89 
...
> pycodestyle 4-hidden_discovery.py; chmod +x 4-hidden_discovery.py; ./4-hidden_discovery.py
...
> pycodestyle 5-variable_load.py; chmod +x 5-variable_load.py; ./5-variable_load.py
